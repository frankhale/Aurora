...
namespace AspNetAdapter
{
  ...
  public static class HttpAdapterConstants
  {
    ...
    public static readonly string WebJsonAppSettings = "WebJsonAppSettings";
  ...
  public sealed class HttpContextAdapter
  {
    ...
    private Dictionary<string, object> InitializeApplicationDictionary()
    {
      ...
      application[HttpAdapterConstants.WebJsonAppSettings] = webJsonInfo;
    ...
    {
      if (_context.Session == null && string.IsNullOrEmpty(key))
      {
        return;
      }
