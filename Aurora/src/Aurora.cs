...
namespace Aurora
{
  ...
  internal class Engine : IAspNetAdapterApplication
  {
    ...
    internal WebJsonInfo WebJsonInfo;
    #endregion
      ...
      Action<Dictionary<string, object>> response)
    {
      ...
      if (viewResponse == null && _currentRoute != null && _currentRoute.Action.ReturnType != typeof(void))
      {
        return;
      }
    ...
    private object PayloadToModel(Dictionary<string, string> payload)
    {
      ...
      if (model != null)
      {
        ...
        foreach (PropertyInfo p in Model.GetPropertiesWithExclusions(model, true))
        {
          ...
          if (notRequiredAttrib != null && !payload.ContainsKey(p.Name))
          {
            continue;
          }
        ...
        if (result is Model model1)
        {
          model1.Validate(payload);
        }
      }
  ...
  public abstract class Model
  {
    ...
    private static bool ValidateRangeAttribute(RangeAttribute rangeAttribute, PropertyInfo property, object value, out string error)
    {
      ...
      if (rangeAttribute != null)
      {
        ...
        {
          result = (((long)value).InRange(rangeAttribute.Min, rangeAttribute.Max)) ? true : false;
        }
        else
        {
          result = false;
  ...
  public abstract class BaseController
  {
    ...
    public WebJsonInfo WebJsonInfo { get { return Engine.WebJsonInfo; } }
